...
int main()
{
    ...
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRId8 "\n", (void*)&i8, sizeof(i8   ), "int8_t", "i8   ", i8   );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRId16 "\n", (void*)&i16, sizeof(i16  ), "int16_t", "i16  ", i16  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRId32 "\n", (void*)&i32, sizeof(i32  ), "int32_t", "i32  ", i32  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRId64 "\n", (void*)&i64, sizeof(i64  ), "int64_t", "i64  ", i64  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdFAST8 "\n", (void*)&if8, sizeof(if8  ), "int_fast8_t", "if8  ", if8  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdFAST16 "\n", (void*)&if16, sizeof(if16 ), "int_fast16_t", "if16 ", if16 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdFAST32 "\n", (void*)&if32, sizeof(if32 ), "int_fast32_t", "if32 ", if32 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdFAST64 "\n", (void*)&if64, sizeof(if64 ), "int_fast64_t", "if64 ", if64 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdLEAST8 "\n", (void*)&il8, sizeof(il8  ), "int_least8_t", "il8  ", il8  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdLEAST16 "\n", (void*)&il16, sizeof(il16 ), "int_least16_t", "il16 ", il16 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdLEAST32 "\n", (void*)&il32, sizeof(il32 ), "int_least32_t", "il32 ", il32 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdLEAST64 "\n", (void*)&il64, sizeof(il64 ), "int_least64_t", "il64 ", il64 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdMAX "\n", (void*)&im, sizeof(im   ), "intmax_t", "im   ", im   );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIdPTR "\n", (void*)&ip, sizeof(ip   ), "intptr_t", "ip   ", ip   );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIu8 "\n", (void*)&ui8, sizeof(ui8  ), "uint8_t", "ui8  ", ui8  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIu16 "\n", (void*)&ui16, sizeof(ui16 ), "uint16_t", "ui16 ", ui16 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIu32 "\n", (void*)&ui32, sizeof(ui32 ), "uint32_t", "ui32 ", ui32 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIu64 "\n", (void*)&ui64, sizeof(ui64 ), "uint64_t", "ui64 ", ui64 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuFAST8 "\n", (void*)&uif8, sizeof(uif8 ), "uint_fast8_t", "uif8 ", uif8 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuFAST16 "\n", (void*)&uif16, sizeof(uif16), "uint_fast16_t", "uif16", uif16);
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuFAST32 "\n", (void*)&uif32, sizeof(uif32), "uint_fast32_t", "uif32", uif32);
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuFAST64 "\n", (void*)&uif64, sizeof(uif64), "uint_fst64_t", "uif64", uif64);
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuLEAST8 "\n", (void*)&uil8, sizeof(uil8 ), "uint_least8_t", "uil8 ", uil8 );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuLEAST16 "\n", (void*)&uil16, sizeof(uil16), "uint_least16_t", "uil16", uil16);
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuLEAST32 "\n", (void*)&uil32, sizeof(uil32), "uint_least32_t", "uil32", uil32);
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuLEAST64 "\n", (void*)&uil64, sizeof(uil64), "uint_least64_t", "uil64", uil64);
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuMAX "\n", (void*)&uim, sizeof(uim  ), "uintmax_t", "uim  ", uim  );
    printf("Adresse: %p, Platzbedarf: %zu, Typ: %s, Name: %s, Wert: %" PRIuPTR "\n", (void*)&uip, sizeof(uip  ), "uintptr_t", "uip  ", uip  );
